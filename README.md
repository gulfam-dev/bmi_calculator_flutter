# SlimCalc BMI Calculator

SlimCalc is a flutter BMI project that enables users to select their gender, enter age, weight, and input height via a slider, swiftly calculating their BMI. It's a user-friendly tool for monitoring health and promoting awareness of body mass index.
